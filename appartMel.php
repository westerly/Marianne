...
<h1 class="titleMenu"> <p> <?php echo $langs->trans("appartMel"); ?> </p></h1>


	<div id="boxRound" class="sizeBoxMel">
		...
		<div class="mySpan12 ml20 left">
			...
			<div class='mySpan8 ml20 left txt'>
				<p class="alinea"><?php echo $langs->trans("descAppartMelP1"); ?> </p>
				<p class="alinea"><?php echo $langs->trans("descAppartMelP2"); ?> </p>
			</div>
		...
		<div class="mySpan10 ml20 left">
			<div id="details" class="mySpan10 left">
				<div class="details">
					<?php echo $langs->trans("detailsRoomMel"); ?>
				</div>
				<div class="details sizeRoom">
					<?php echo $langs->trans("detailsBathroomMel"); ?>
				</div>
				<div class="details sizeRoom">
					<?php echo $langs->trans("detailsLivingRoomMel"); ?>
				</div>
			</div>
			<div class="mySpan10 left">
				<div class="details sizeKitchen">
					<?php echo $langs->trans("detailsKitchenMel"); ?>
				</div>
				<div class="details sizeKitchen">
					<?php echo $langs->trans("detailsExtrasMel"); ?>
				</div>
				<div class="details sizeKitchen">
					<?php echo $langs->trans("detailsMiscellaneousMel"); ?>
				</div>
			</div>
		</div>
...
?>
	<div id="calendarMel" class="calendar left divDispo">
